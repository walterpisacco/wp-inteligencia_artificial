...
$(document).ready(function () {
    ($sidebar = $(".sidebar")),
        ...
        $(".dropdown-menu a.dropdown-toggle").on("click", function (e) {
            ...
            return (
                ...
                t.parent().hasClass("navbar-nav") || a.next().css({ top: a[0].offsetTop, left: t.outerWidth() - 4 }),
                !1
            );
        }),
    ...
    (md = {
        ...
        startAnimationForBarChart: function (e) {
            e.on("draw", function (e) {
                "bar" === e.type && (seq2++, e.element.animate({ opacity: { begin: seq2 * delays2, dur: durations2, from: 0, to: 1, easing: "ease" } }));
            }),
                (seq2 = 0);
        },
            ...
            ($calendar = $("#fullCalendar")),
                ...
                $calendar.fullCalendar({
                    ...
                    events: [
                        ...
                        { id: 999, title: "Repeating Event", start: new Date(y, m, d - 4, 6, 0), allDay: !1, className: "event-rose" },
                        { id: 999, title: "Repeating Event", start: new Date(y, m, d + 3, 6, 0), allDay: !1, className: "event-rose" },
                        { title: "Meeting", start: new Date(y, m, d - 1, 10, 30), allDay: !1, className: "event-green" },
                        { title: "Lunch", start: new Date(y, m, d + 7, 12, 0), end: new Date(y, m, d + 7, 14, 0), allDay: !1, className: "event-red" },
                        { title: "Md-pro Launch", start: new Date(y, m, d - 2, 12, 0), allDay: !0, className: "event-azure" },
                        { title: "Birthday Party", start: new Date(y, m, d + 1, 19, 0), end: new Date(y, m, d + 1, 22, 30), allDay: !1, className: "event-azure" },
        ...
        initVectorMap: function () {
            $("#worldMap").vectorMap({
                ...
                series: { regions: [{ values: { AU: 760, BR: 550, CA: 120, DE: 1300, FR: 540, GB: 690, GE: 200, IN: 200, RO: 600, RU: 300, US: 2920 }, scale: ["#AAAAAA", "#444444"], normalizeFunction: "polynomial" }] },
            });
        },
    });
